...
// Defined at module scope so its identity is stable across every render of the
// editor. Passing an inline `(props) => ...` to `cellMenu` would give the menu
// a new component type on each render, remounting the whole menu subtree
// continuously and eventually throwing "Maximum update depth exceeded".
const NotionTableCellMenu: NonNullable<
  TableSelectionOverlayProps["cellMenu"]
> = (props) => (
  <TableCellHandleMenu
    editor={props.editor}
